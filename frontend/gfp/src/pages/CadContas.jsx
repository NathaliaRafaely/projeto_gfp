...
export default function CadContas() {
    ...
    useEffect(  () => {
        if(itemAlterar){
            ...
            setTipoConta(itemAlterar.tipoConta);
            ...
            <section className='w-full max-w-lg bg-white p-8 rounded-lg shadow-lg text-gray-800'>
                ...
                <header className='flex itens-center gap-2 mb-6 border-b border-gray-200 pb-4 '>
                    ...
                    <h2 className='text-2xl font-bold'>
                        { itemAlterar ? 'Editar conta' : 'Criar conta'}
                        </h2>
                ...
                {/*Formulario de cadastro */}
                    <div className='space-y-5'>
                        ...
                        <select value={tipoConta} onChange={(e) => setTipoConta(e.target.value)}
                            ...
                            <option value='CARTÂO_CREDITO'> Cartão Credito</option>
                            <option value='CARTÂO_DEBITO'> Cartão Debito</option>
                        ...
                        <input type='number' value={saldoInicial}
                            ...
                            className={Estilos.inputCadastro} />
                        {/* Botões de Controle */}
                        <div className='flex jusfify-end gap-3 mt-8'>
                            <button className={Estilos.botaoOutline} onClick={() => navigate('/contas')}>
                                <MdClose />Cancelar
                            </button>
                            <button className={Estilos.botao2} onClick={botaoSalvar}>
                                <MdSave />Salvar
                            </button>
